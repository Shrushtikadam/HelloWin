...
#pragma comment(lib,"user32.lib") // explixitly link kravi lagtat libraries
#pragma comment(lib,"gdi32.lib")
#pragma comment(lib,"kernel32.lib") // pragma is preprocessor directive

LRESULT CALLBACK WndProc(HWND hwnd,UINT uMsg,WPARAM wPAaram,LPARAM lParam);

int WINAPI WinMain(HINSTANCE hINstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine,int nShowCmd )
{
    static TCHAR szClassName[] = TEXT("the Standard Window Class");
    static TCHAR szWindowTitle[] =TEXT("HELLOWIN->SHRUSHTI KADAM");
